...
import mc.mian.indestructible_blocks.platform.services.IPlatformHelper;
import mc.mian.indestructible_blocks.platform.services.IRegistryCreator;
...
public class Services {
    ...
    public static <T> T load(Class<T> clazz) {
        ...
        IndestructibleBlocks.LOGGER.debug("Loaded {} for service {}", loadedService, clazz);
